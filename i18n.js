...
(() => {
  ...
  const TRANSLATIONS = {
    ...
    'logo.tagline':        { fr: 'Promotion immobilière · Côte d\u2019Azur',
                             en: 'Real estate development · French Riviera' },
    ...
    'home.about.h2':       { fr: 'Une promotion à taille humaine, au plus près de la pierre.',
                             en: 'Small-scale development, working as close to the stone as possible.' },
    'home.about.p1':       { fr: 'Depuis le Vieil Antibes, nous identifions des immeubles oubliés du tissu ancien — façades du XVIIIᵉ, hôtels particuliers, échoppes du bord de mer — et les ramenons à la vie avec un soin presque artisanal.',
                             en: 'From Old Antibes, we identify forgotten buildings of the historic fabric — 18th-century façades, private mansions, seaside shops — and bring them back to life with an almost artisanal care.' },
    'home.about.p2':       { fr: 'Chaque projet est conduit lot par lot, en lien direct avec les acquéreurs : choix des matériaux, agencement des volumes, finitions sur mesure. C\u2019est une autre manière de faire de la promotion, plus lente, plus juste, plus durable.',
                             en: 'Each project is run unit by unit, in direct contact with buyers: material choices, spatial layout, made-to-measure finishes. A different way of developing real estate — slower, more thoughtful, more lasting.' },
    ...
    'op.jds.eb':           { fr: 'Opération phare · 9 lots', en: 'Flagship project · 9 units' },
    ...
    'op.jds.p':            { fr: 'Sur deux immeubles mitoyens du cœur historique, Les Jardins de Sade ressuscitent un ensemble du XVIIIᵉ siècle : façades en pierre, voûtes anciennes, terrasses arborées en cœur d\u2019îlot. Neuf appartements — du T2 au T4 — composent une partition rare, mêlant la patine de l\u2019ancien et des prestations contemporaines pensées dans la longue durée.',
                             en: 'On two adjoining buildings in the historic core, Les Jardins de Sade bring an 18th-century complex back to life: stone façades, ancient vaults, planted terraces in the heart of the block. Nine apartments — from one-bedroom to three-bedroom — make for a rare composition, blending the patina of old stone with contemporary fittings designed to last.' },
    ...
    'op.jds.lots':         { fr: '9 lots', en: '9 units' },
    'op.jds.types':        { fr: 'T2 → T4', en: '1 → 3 bedrooms' },
    'op.jds.surfaces':     { fr: '28 → 102 m²', en: '28 → 102 m²' },
    'op.jds.b1':           { fr: 'Bâtiment historique', en: 'Historic building' },
    'op.jds.b2':           { fr: 'Éligible déficit foncier', en: 'Heritage tax eligible' },
    'op.jds.b3':           { fr: 'Sur-mesure acquéreurs', en: 'Tailored for buyers' },
    'op.jds.cta1':         { fr: 'Voir les 9 lots disponibles', en: 'See the 9 available units' },
    ...
    'lot.25sade.intro':    { fr: 'Au cœur de la Place Nationale, ce T2 de 51 m² s\u2019inscrit dans la réhabilitation soignée d\u2019un immeuble de caractère du Vieil Antibes. Combles aménagés, vue directe sur la place, livré entièrement rénové, meublé et clé en main.',
                             en: 'In the heart of Place Nationale, this 51 m² one-bedroom apartment is part of the careful restoration of a character building in Old Antibes. Converted attic, direct view onto the square, delivered fully renovated, furnished and turnkey.' },
    'lot.bateau.intro':    { fr: 'Sur les remparts d\u2019Antibes, en première ligne face à la Méditerranée, un appartement rare suspendu entre ciel et mer. En cours de rénovation avec des prestations haut de gamme, ce 3/4 pièces de 66 m² loi Carrez — complété par une mezzanine — offre une atmosphère lumineuse et une vue mer imprenable depuis le séjour. Vendu entièrement meublé et équipé.',
                             en: 'On the ramparts of Antibes, front-line facing the Mediterranean, a rare apartment suspended between sky and sea. Currently under high-end renovation, this 3/4-room apartment (about 66 m² Carrez law) — with an additional mezzanine — offers a bright atmosphere and an unobstructed sea view from the living room. Sold fully furnished and equipped.' },
